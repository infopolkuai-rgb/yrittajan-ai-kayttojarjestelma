...
Yritys, palvelut ja asiakkaat: `tausta/yritys.md`. Prioriteetit: `tausta/prioriteetit.md`. Kirjoitustyyli: `tausta/aani.md`. Lue ne, älä toista niiden sisältöä täällä.
...
| `haastattelut/` | Syvenna-ajojen tallenteet. Yksityisiä |
| `tarkistukset/` | Tarkista-raportit. Yksityisiä |
| `arkisto/` | Vanhentunut tavara. Siirrä tänne, älä poista |

Sääntö: tänne se mitä luet ajaessa, arkistoon se mikä on ohi.
...
- Suoraan ja lyhyesti. Kärki ensin, tilannekatsaus vasta jos kysytään.
- Kun kysyn jotain, vastaa. Älä toista kysymystäni.
- Kun teemme päätöksen, ehdota kirjausta paatokset/loki.md-tiedostoon.
