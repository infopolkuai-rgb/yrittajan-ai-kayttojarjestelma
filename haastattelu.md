...
Tämä tiedosto on `/aloita`-komennon lähde. Voit täyttää sen etukäteen käsin tai antaa haastattelun täyttää sen puolestasi. Molemmat käyvät.

Muokkaa tätä ja aja `/aloita` uudelleen aina kun jokin muuttuu.
...
*Liitä 1-2 tekstiä, jotka olet oikeasti kirjoittanut. Sähköposti asiakkaalle, LinkedIn-postaus, tarjous. Liitä ne sellaisenaan. Älä siisti äläkä kirjoita uutta tähän: silloin näytteestä tulee sellainen kuin luulet kirjoittavasi, ei sellainen kuin kirjoitat.*
...
*Jokaisessa pitää olla joko luku tai päivämäärä. Kasvattaa myyntiä ei kelpaa. Kolme uutta asiakasta lokakuun loppuun mennessä kelpaa.*
...
*Drive, OneDrive, kovalevy, Notion, sähköpostin liitteet, vihko. Kerro totuus, ei tavoitetila.*
